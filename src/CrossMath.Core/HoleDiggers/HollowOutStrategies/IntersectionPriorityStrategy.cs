...
/// 每个交点格权重7，每个非交点格权重3
/// </summary>
public class IntersectionPriorityStrategy : IHollowOutStrategy
{
    public bool AllowHollowOutOperator => _allowHollowOutOperator;
    private bool _allowHollowOutOperator = false;
    
    private const int IntersectionWeight = 7;
    private const int NonFocusWeight = 3;

    private Dictionary<RowCol, int>? _allAllowRowColWeights = null;

    public IntersectionPriorityStrategy(bool allowHollowOutOperator = false)
    {
