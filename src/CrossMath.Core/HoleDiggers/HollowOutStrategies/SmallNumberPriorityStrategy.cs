...
public class SmallNumberPriorityStrategy: IHollowOutStrategy
{
  public bool AllowHollowOutOperator => false;
    ...
    public Dictionary<RowCol, double>? GetWeights(HollowOutContext context, IEnumerable<RowCol>? candidatePositions = null)
    {
    ...
    public Dictionary<RowCol, double> GetAllAllowRowColWeights(HollowOutContext context)
    {
        ...
        var rowColWeights =  allNumbersPos.ToDictionary(
            rowcol => rowcol,
