...
public record EmptyBoardBrief
{
    ...
    public override string ToString()
    {
        ...
        sb.AppendLine($"EmptyBoardBrief - h({Size.Height})×w({Size.Width})");
        sb.AppendLine($"Formulas: Total={FormulaCount}, 7-Length={Formula7Count}, Z-Type={FormulaZCount}");
        sb.AppendLine($"Structure: Rings={RingCount}, Crosses={CrossCount}, Coverage={FormulaCoverage:P2}");
        sb.AppendLine($"Sigma: Overall={Sigma:F2}, Outermost={SigmaOutermost:F2}");
        sb.AppendLine($"Outermost: T={OutermostTop} B={OutermostBottom} L={OutermostLeft} R={OutermostRight}");
        sb.AppendLine($"Outer: T={OuterTop} B={OuterBottom} L={OuterLeft} R={OuterRight}");
        sb.AppendLine($"Layout: {LayoutInfo}");
        return sb.ToString();
    }
}
