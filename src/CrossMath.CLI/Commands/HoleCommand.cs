...
public class HoleCommand : CliCommandBase
{
    ...
    public HoleCommand() : base("hole", "终盘挖空") { }
    ...
    protected override Task<int> HandleAsync(ParseResult parse)
    {
        ...
        var pipeLine = new HoleBoardPipeline(new HoleRunner());
        var job = new HoleJob(pipeLine, needProgress ? new StdOutProgressWriter() : null);
